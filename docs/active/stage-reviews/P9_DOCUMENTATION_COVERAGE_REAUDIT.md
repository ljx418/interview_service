...
- `02_TARGET_ARCHITECTURE.md` 已列出 `TopServiceBar`、`LeftIntelligencePanel`、`MarketMapView`、`OpportunityMatchPanel`、`ApplicationPipelineView`、`ConversationPlane`、`JourneyStateHeader`、`RightArtifactBench` 等 UI 实体；
