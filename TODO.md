...
P0 已冻结并完成 M5、M7、M8、M9/M13 维护和 PiAgent 编排接入。P1 已完成本地工程闭环和可见验收。P2 已完成 examples-guided Chatbox 端到端体验，并补充 MiniMax opt-in 真实 provider 受控验收。P3 已完成本地自动化验收：真实用户 Chatbox 体验、对话响应闭环、对话区/推进台分离、响应式 UX、截图证据和 HTML 报告已落地；真实个人资料、真实外部调用和最终主观体验审查仍需人工确认。人工审查认可 P3 验收报告的大部分内容，但对当前用户体验不完全认同，P4 候选阶段应优先做 UX 体验优化。
...
- [ ] P4-UX0：基于当前 P3 截图和人工反馈制定 UX 问题清单、验收标准和 before/after 截图计划。
...
- [ ] P4-UX6：制作 UX before/after HTML 审查包，并把人工体验意见作为出门条件。
- [ ] MCP Server wrapper。
- [ ] CLI 命令。
