...
P0 已冻结并完成 M5、M7、M8、M9/M13 维护和 PiAgent 编排接入。P1 已完成本地工程闭环和可见验收。P2 已完成 examples-guided Chatbox 端到端体验，并补充 MiniMax opt-in 真实 provider 受控验收。P3 已完成本地自动化验收：真实用户 Chatbox 体验、对话响应闭环、对话区/推进台分离、响应式 UX、截图证据和 HTML 报告已落地；真实个人资料、真实外部调用和最终主观体验审查仍需人工确认。人工审查认可 P3 验收报告的大部分内容，但对当前用户体验不完全认同，当前 P4 阶段优先做 UX 体验强化。P4B 已把全尺寸桌面体验列为 hard gate：1200px、1440px、1600px、1920px 不能出现布局错误造成的大面积空白，截图脚本也不能污染人工审查浏览器 viewport。
...
- [ ] P4-UX1：优化信息架构和首屏层级，降低 Chatbox / 推进台认知负担。
- [ ] P4-UX2：优化任务入口和下一步引导，让上传资料、粘贴 JD、生成申请包形成自然流程。
- [ ] P4-UX3：优化产物卡可读性，减少 JSON 暴露，突出摘要、确认项、版本和导出。
- [ ] P4-UX4：强化处理中、失败、缺资料和恢复路径的状态反馈。
- [ ] P4-UX5：做响应式精修，让 390px / 720px / 1280px 不只是可用，而是顺手。
- [ ] P4-UX5A：修复全尺寸桌面工作台体验，覆盖 1200px / 1440px / 1600px / 1920px，消除布局错误造成的大面积空白。
- [x] P4-UX5B：修复截图脚本 viewport emulation 清理，避免自动截图污染人工审查浏览器。
- [ ] P4-UX6：制作 UX before/after HTML 审查包，并把全尺寸桌面、窄屏、移动端人工体验意见作为出门条件。
- [ ] P4-UX7：收集 Gemini 前端审查意见，评估是否存在重大 UX 偏差或过度承诺。
