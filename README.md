...
## 当前 MVP / P9 Chatbox-native 自动化候选阶段
...
- `docs/active/01_STAGE_PRD.md` - P9 Chatbox-native PRD、P8.1/P8 自动化候选基线、P5.5/P6/P7 历史阶段边界。
- `docs/active/02_TARGET_ARCHITECTURE.md` - P9 顶部服务中心、左侧求职态势图、中央 Chatbox、右侧产物台目标架构、当前架构差异和具体代码实体关系。
- `docs/active/03_MILESTONES_AND_DELIVERY_PLAN.md` - P9 文档阶段与后续开发里程碑、历史阶段里程碑和出门条件。
- `docs/active/04_ACCEPTANCE_GATES.md` - P9 Chatbox-native 求职工作台验收门槛、P8.1/P8 历史门槛、P7-post P5-REAL 复验条件和最终出门条件。
